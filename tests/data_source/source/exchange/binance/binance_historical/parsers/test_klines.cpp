...
const auto& kUsdM = qp::data_source::source::exchange::binance::endpoint(
    qp::data_source::source::exchange::binance::BinanceMarket::UsdM,
    qp::data_source::source::exchange::binance::EndpointKind::Klines);
...
TEST(BinanceKlineParser, CoinMVolumeIsBaseAssetNotContracts) {
    ...
    const auto& coin_m = qp::data_source::source::exchange::binance::endpoint(
        qp::data_source::source::exchange::binance::BinanceMarket::CoinM,
        qp::data_source::source::exchange::binance::EndpointKind::Klines);
