...
// legs) -> CombinedTransport -> Engine<..., BasicRiskGate, 1,
// FundingCarryStrategy> — actually produces the delta-neutral position
// funding carry is supposed to, not just that each piece compiles.
